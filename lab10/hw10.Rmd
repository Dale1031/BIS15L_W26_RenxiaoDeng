...
sharks %>% 
  ...
  geom_col()+
  coord_flip()+
  labs(title="Observation by County",
       x="County",
       y="count")
```
...
sharks %>%
  ...
  geom_bar()+
  coord_flip()+
  labs(title="Incident By County")+
  theme(plot.title=element_text(size=rel(1.3),hjust=.5))
```
...
```{r}
  ...
  geom_bar()+
  coord_flip()+
  labs(title="Incident by Activity")+
  theme(plot.title=element_text(size=rel(1.3),hjust=.5))
```
...
sharks %>%
  ...
  geom_bar()+
  coord_flip()+
  labs(title="Incident of Great White by Activity")+
  theme(plot.title=element_text(size=rel(1.3),hjust=.5))
```
