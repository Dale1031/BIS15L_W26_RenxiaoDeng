...
```{r, eval=FALSE,echo=TRUE}
ggmap(map1) +
  geom_point(data=sharks,aes(longitude,latitude),size=0.75,color="red",alpha=0.8)+
  labs(x="Longitude",y="Latitude",title="CA Shark Attacks Records")
```
...
```{r, eval=FALSE,echo=TRUE}
ggmap(map1) +
  geom_point(data=sharks_fatal,aes(longitude,latitude),size=1,color="red",alpha=0.8)+
  labs(x="Longitude",y="Latitude",title="CA Shark Attacks Records")
```
...
```{r, eval=FALSE,echo=TRUE}
ggmap(map1) +
  geom_point(data=sharks_SD,aes(longitude,latitude),size=1,color="red",alpha=0.8)+
  labs(x="Longitude",y="Latitude",title="San Diego Shark Attacks Records")
```
## Knit and Upload
