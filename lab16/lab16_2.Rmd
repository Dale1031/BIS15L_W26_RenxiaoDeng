...
```{}
scc2103-09:Desktop daledeng$ mv genome01_blastn.csv BIS15L_W26_RenxiaoDeng/lab16/data/blast_results
scc2103-09:Desktop daledeng$ 
```
...
```{r}
blast_data <- read_csv("data/blast_results/genome01_blastn.csv") %>% 
  clean_names()
```
...
```{r}
readAAStringSet("data/e.coli_coding_seq.fasta")
```
...
```{}
scc2103-09:Desktop daledeng$ mv blastp_results.csv BIS15L_W26_RenxiaoDeng/lab16/data/blast_results/
scc2103-09:Desktop daledeng$ 
```
