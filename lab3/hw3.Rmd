...
mountain_meter <- c(8848,8611,8586,8516,8485)
mountain_feet <- mountain_meter*3.28
```

**2. Combine these vectors into a data frame called `mountains`.**
```{r}
mountains <- tibble(mountain_name, mountain_meter, mountain_feet)
```

**3. What is the mean height of the mountains in feet?**
```{r}
mean(mountains$mountain_feet)
```
